...
favoriteThings.show = 'FLCL';

// console.log(`after add: ${favoriteThings.show}`);
...
const myFirstVehicle = new Vehicle(2, 'blue', 25);
...
const myFirstMotorcycle = new Motorcycle(1, 'red', 5000, 'Kawasaki', false);
...
const myFirstBoat = new Boat(4, 'brown', 25000, 'Boaty McBoatface', 'speedboat', false);
